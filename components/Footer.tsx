  ...
  return (
    <>
      <div className="hidden md:block">
        <div className="min-h-[50vh] px-10 md:px-20 py-20 flex flex-col">
          <div className="flex flex-col md:flex-row lg:flex-row">
            <div className="flex flex-col w-1/3 gap-10 md:gap-5">
              <div className="hidden md:flex flex-col gap-5">
                <Link href={"/"}>
                  <Image src="/images/Logo.svg" alt="Logo" width={300} height={300} />
                </Link>
                <p className="text-white text-[5xl] md:text-2xl">
            ...
            <div className="hidden md:flex flex-col gap-10 mb-10 md:mb-0 w-full md:w-1/3">
              <div className="">
              ...
              <div className="flex gap-2">
                <input type="email" name="email" id="email" placeholder="Get news and updates..." className="w-full px-2 text-black rounded-xl" />
                <Button
                  title="Send"
                  href="/"
            ...
            <div className="flex md:hidden gap-3 w-full justify-center md:justify-start items-center">
              <a
                href="https://www.facebook.com/share/md5fj8xbXcZXsATh/?mibextid=qi2Omg"
                target="_blank"
                rel="noopener noreferrer"

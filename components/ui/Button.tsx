...
const Button: FC<ButtonProps> = ({
    ...
    return (
        <a href={href} onClick={onClick} className={cn(`bg-[#FFD989] border text-black flex items-center hover:bg-black hover:border-[#FFD989] hover:text-[#FFD989] transition-all duration-500`, className)}>
            {title}
            {icon && (
                <span

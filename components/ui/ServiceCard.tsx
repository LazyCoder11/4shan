    ...
    return (
        <div className='h-fit flex flex-col border-2 rounded-3xl border-[#FFD989] bg-gradient-to-t from-black to-[#ffda8960] card-shadow'>
            <div className=" p-10 flex flex-col gap-5">
                ...
                <div className="">
                    <Button title='Read more' href='/' icon='/images/Arrow.svg' iconHeight={18} iconWidth={18} className='px-10 py-2 rounded-xl gap-5 justify-center text-xl transition-all duration-700'/>
                </div>
            </div>
        </div>
    );
